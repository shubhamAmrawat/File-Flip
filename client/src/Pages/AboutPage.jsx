          ...
          <div class="container mx-auto">
            ...
            <div class="mx-auto grid max-w-4xl gap-8 md:grid-cols-3">
              <div class="flex flex-col items-center text-center">
                <div class="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-rose-100 text-rose-500">
                  <svg
                    ...
                    class="lucide lucide-cloud-upload h-8 w-8"
                  >
                ...
                <h3 class="mb-2 text-xl font-semibold">1. Upload Your File</h3>
              ...
              <div class="flex flex-col items-center text-center">
                <div class="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-rose-100 text-rose-500">
                  <svg
                    ...
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    class="lucide lucide-download h-8 w-8"
                  >
                ...
                <h3 class="mb-2 text-xl font-semibold">3. Download Result</h3>
                <p class="text-gray-600">
        ...
        <section class="container mx-auto px-4 py-16">
          ...
          <div class="mx-auto grid max-w-5xl gap-8 md:grid-cols-2">
            <div class="flex gap-4">
              <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-sky-100 text-sky-500">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <div class="flex gap-4">
              ...
              <div>
                <h3 class="mb-2 text-xl font-semibold">100% Secure</h3>
                <p class="text-gray-600">
            ...
            <div class="flex gap-4">
              ...
              <div>
                <h3 class="mb-2 text-xl font-semibold">High Quality</h3>
                <p class="text-gray-600">
            ...
            <div class="flex gap-4">
              <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-sky-100 text-sky-500">
                <svg
                  ...
                  stroke-linecap="round"
                  stroke-linejoin="round"
                  class="lucide lucide-circle-check-big h-5 w-5"
                >
              ...
              <div>
                <h3 class="mb-2 text-xl font-semibold">Easy to Use</h3>
                <p class="text-gray-600">
        ...
        <section class="mx-auto px-4 py-16">
          <div class="mx-auto max-w-3xl rounded-xl  bg-gray-50/50 p-8 shadow-md">
            ...
            <div class="flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a href="/contact">
                <button class="flex items-center rounded-lg bg-rose-50  text-rose-500 font-medium cursor-pointer hover:bg-rose-100 h-10 py-2 gap-2 px-6">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
              ...
              <a href="/convert">
                <button class="flex items-center rounded-lg bg-rose-500 text-gray-50 font-medium cursor-pointer hover:bg-rose-600 h-10 py-2 gap-2 px-6">
                  Try File-Flip
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
